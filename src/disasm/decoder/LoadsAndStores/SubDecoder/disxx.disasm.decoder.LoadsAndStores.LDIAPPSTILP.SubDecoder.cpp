...
namespace disxx::disasm::decoder::LoadsAndStores::LDIAPPSTILP
{
	...
	DisassemblyResult SubDecoder::Decode(void) const noexcept(false)
	{
        ...
        this->m_Operands.emplace_back(std::make_unique<disxx::disasm::operand::Register>(disxx::disasm::operand::Register::Type::TYPE_GPR, Rt2, size == 0b11 ? 64 : 32));
        ...
        if (opc2 == 0b0000)
        {
            if (L == 0b0)
            {
                static_cast<disxx::disasm::operand::LoadsAndStoresAddress *>(this->m_Operands.rbegin()->get())
                    ->AddImmediatePreIndexedOffset(size == 0b11 ? -16 : -8, false);
