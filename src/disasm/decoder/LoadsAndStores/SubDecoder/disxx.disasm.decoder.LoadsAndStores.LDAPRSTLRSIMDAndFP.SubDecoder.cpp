...
namespace disxx::disasm::decoder::LoadsAndStores::LDAPRSTLRSIMDAndFP
{
	...
	DisassemblyResult SubDecoder::Decode(void) const noexcept(false)
	{
        ...
        static const std::unordered_map<unsigned short int, std::pair<InstructionID, unsigned short int>> insnTable = {
            {0b0000, {InstructionID::INSN_STLUR, 8}},
            {0b0001, {InstructionID::INSN_LDAPUR, 8}},
            {0b0010, {InstructionID::INSN_STLUR, 128}},
            {0b0011, {InstructionID::INSN_LDAPUR, 128}},
            {0b0100, {InstructionID::INSN_STLUR, 16}},
            {0b0101, {InstructionID::INSN_LDAPUR, 16}},
        ...
        this->m_Operands.emplace_back(std::make_unique<disxx::disasm::operand::Register>(disxx::disasm::operand::Register::Type::TYPE_NEON, Rt, regSize));
