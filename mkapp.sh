...
then
	...
	cp ./src/app/build/dependencies/libdisxx-util.dylib ./dis++.app/Contents/Frameworks/libdisxx-util.dylib
	cp ./src/app/build/dependencies/libdisxx-ui.dylib ./dis++.app/Contents/Frameworks/libdisxx-ui.dylib
	cp ./src/app/build/dependencies/libdisxx-macho.dylib ./dis++.app/Contents/Frameworks/libdisxx-macho.dylib
	cp ./src/app/build/dependencies/libdisxx-disasm.dylib ./dis++.app/Contents/Frameworks/libdisxx-disasm.dylib
	...
	cp ./src/app/build/dependencies/libdisxx-macho.dylib ./dis++/libdisxx-macho.dylib
